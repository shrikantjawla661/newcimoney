...
function getAdminFormData(period) {
  $.ajax({
    url: "/dashboard/form-filled-info",
    type: "POST",
    data: {
      period: period,
    },
...
function getAdminCardData(period) {
  $.ajax({
    url: "/dashboard/credit-card-info",
    type: "POST",
    data: {
      period: period,
    },

    ...
    var handleForm = function (e) {
        ...
        submitButton.addEventListener('click', function (e) {
            ...
            if (validated === true) {
                ...
                let otp = form.querySelector("[name=code_1]").value;
                otp += form.querySelector("[name=code_2]").value;
                otp += form.querySelector("[name=code_3]").value;
                otp += form.querySelector("[name=code_4]").value;
                otp += form.querySelector("[name=code_5]").value;
                otp += form.querySelector("[name=code_6]").value;
                $.ajax({
                    type: "POST",
                    url: "/auth/verify-otp",
                ...
                function handleLoginSuccess() {
                    ...
                    Swal.fire({
                        ...
                        customClass: {
                            confirmButton: "btn btn-primary back-to-home"
                        },
                    });
                  }
                // setTimeout(function() {
